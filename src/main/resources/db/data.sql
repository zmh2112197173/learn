...
INSERT INTO `Student` (id, number, name, sex, classnum, avatar_url) VALUES ('1', '001', '李华', '男', '1','');
INSERT INTO `Student` (id, number, name, sex, classnum, avatar_url) VALUES ('2', '002', '张丽', '女', '1','');
INSERT INTO `Student` (id, number, name, sex, classnum, avatar_url) VALUES ('3', '003', '王五', '男', '2','');
INSERT INTO `Student` (id, number, name, sex, classnum, avatar_url) VALUES ('4', '004', '张萍', '女', '2','');
